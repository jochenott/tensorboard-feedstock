...
pixi add tensorboard
# for installing globally
pixi global install tensorboard
```
...
It is possible to list all of the versions of `tensorboard` available on your platform:
...
```
pixi search tensorboard --channel conda-forge
```
